...
## Overview
Svelte DevTools 0.2.1 is an early-development npm-workspaces monorepo with 5 packages. This documentation is for developers CONTRIBUTING to the devtools themselves.

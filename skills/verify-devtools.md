...
This reference targets source release 0.2.0 and the tested `@vitejs/devtools` 0.4.8 host. Start with [source installation](../docs/02_vite-plugin.md#installation). The 0.2.x packages are not published to npm.

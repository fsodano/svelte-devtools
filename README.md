...
**Early development · v0.2.2.** APIs may change. This is an independent community project, inspired by Vue DevTools; it is not an official Svelte project.
...
For manual setup, use the [Vite configuration below](#integrate-with-your-app). Start your app, open the Vite dock, authorize with the terminal's **six-digit devframe code**, and choose **Svelte**. No browser extension is required.

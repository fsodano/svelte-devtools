# Svelte DevTools — Browser runtime

**Connect Svelte component instrumentation to the development panel.**

Tracks mounted instances, state and prop events, element inspection, and browser fetch observations. The Vite plugin supplies this runtime; applications normally install the plugin rather than loading this package directly.
